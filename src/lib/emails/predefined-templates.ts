...
<div style="font-family: sans-serif; color: #333; line-height: 1.6;">
  ...
  <p style="margin-bottom: 16px;">Hola <strong>{{customerName}}</strong></p>
  <p style="margin-bottom: 16px;">Tu compra <strong>{{productName}}</strong> ha sido procesada correctamente.</p>
  ...
  },
  {
    ...
    subject: "Suscripción activa {{productName}}",
    emoji: "🔄",
    blocks: [],
    custom_html: `
<div style="font-family: sans-serif; color: #333; line-height: 1.6;">
  ...
  <p style="margin-bottom: 16px;">Hola <strong>{{customerName}}</strong></p>
  <p style="margin-bottom: 16px;">Te confirmamos que tu suscripción <strong>{{productName}}</strong> <strong>{{amount}}</strong> está activa y lista para usar.</p>
...
<div style="font-family: sans-serif; color: #333; line-height: 1.6;">
  ...
  <p style="margin-bottom: 16px;">Hola <strong>{{customerName}}</strong></p>
  <p style="margin-bottom: 16px;">Te informamos que tu solicitud de reembolso ha sido aprobada y el monto <strong>{{amount}}</strong> ha sido procesado correctamente.</p>
